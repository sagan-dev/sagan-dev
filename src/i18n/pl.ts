...
export const pl: Translations = {
  ...
  toolbox: {
    ...
    description:
      "Małe, lokalne narzędzia do codziennej pracy z bezpieczeństwem i integracjami. Token zostaje w przeglądarce.",
    in: "za",
    ago: "temu",
    missing: "brak",
    ...
    jwt: {
      ...
      placeholder: "Wklej tutaj access_token albo id_token...",
      ...
      groups: "Grupy",
      scopes: "Scope'y",
      claims: "Czytelne claimy",
    },
    unix: {
      title: "Linux time",
      subtitle: "Przelicza Unix timestamp i pokazuje dystans aktualizowany na żywo.",
      inputLabel: "Unix timestamp",
      placeholder: "np. 1767225600 albo 1767225600000",
      delta: "Dystans czasu",
      date: "Data i czas",
      normalized: "Sekundy po normalizacji",
    },
    tls: {
      title: "Certyfikat TLS",
      subtitle: "Sprawdza czytelne detale certyfikatu HTTPS dla publicznego hosta.",
      inputLabel: "Domena albo URL HTTPS",
      placeholder: "np. sagan.dev albo https://api.example.com",
      check: "Sprawdź certyfikat",
      checking: "Sprawdzam...",
      status: "Status certyfikatu",
      valid: "Zaufany przez domyślny store",
      invalid: "Niezaufany przez domyślny store",
      validFrom: "Ważny od",
      validTo: "Ważny do",
      expiresIn: "Wygasa za",
      expiredAgo: "Wygasł",
      subject: "Wystawiony dla",
      issuer: "Wystawiony przez",
      altNames: "Nazwy alternatywne",
      fingerprints: "Fingerprinty",
      connection: "Połączenie TLS",
      chain: "Łańcuch certyfikatów",
      protocol: "Protokół",
      cipher: "Cipher",
      checkedAt: "Sprawdzone o",
      exactHost: "Dokładny host TLS",
